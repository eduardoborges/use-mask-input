...
const config: Config = {
  ...
  url: 'https://use-mask-input.eduardoborges.dev',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/eduardoborges/use-mask-input/tree/main/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} use-mask-input. Built with Docusaurus.`,
    },
    prism: {
